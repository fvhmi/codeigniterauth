...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container">
            <a class="navbar-brand" href="<?= base_url() ?>">CI Auth Bootstrap 4</a>
    ...
    <div class="container">
        <br>
        <form class="form-horizontal" method="POST" action="<?= base_url('auth/signup') ?>">
                    ...
                    <div class="form-group has-danger">
                        ...
                        <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                            ...
                            <input type="text" name="nama" class="form-control" id="nama"
                                   placeholder="Your Name" value="<?= set_value('nama'); ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row" style="padding-top: 1rem">
                ...
                <div class="col-md-6">
                    ...
                    <a class="btn btn-link" href="<?= base_url('auth') ?>">Login</a>
                </div>
            </div>
